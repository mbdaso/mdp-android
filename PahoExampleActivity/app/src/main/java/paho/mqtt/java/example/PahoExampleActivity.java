 ...
 *
 * Modified for Máster IoT (Mobile Devices Programming)
 *
 */
...
//    final String publishMessage = "Hello World!";
    ...
    final String publishTopic = "channels/877274/publish/fields/field3/U64KHBULKLVNAAF6";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mqttConnectOptions.setUserName( "mbdaso" );
        mqttConnectOptions.setPassword( "A0ECZ80BBI8FKPPB".toCharArray() );
